...
export default function About() {
  return (
    <section
      id="about"
      className=" h-[32rem] md:min-h-screen bg-neutral-950 relative flex flex-col items-center justify-center antialiased"
    >
      <div className="max-w-5xl mx-auto p-4">
        ...
        <p className="text-neutral-400 max-w-5xl text-xl mx-auto my-2 text-md text-justify relative z-10">
