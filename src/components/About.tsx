...
export default function About() {
  return (
    <section
      id="about"
      className=" h-[28rem] md:min-h-screen bg-neutral-950 relative flex flex-col items-center justify-center antialiased"
    >
      <div className="max-w-2xl mx-auto p-4">
        ...
        <p></p>
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-md text-justify relative z-10">
